...
let myBalance : number = 1040000;
const myPin : number = 4567;
...
if (
    ...
    if (
        operationAns.operator === "Withdraw"
    ){
        ...
        operationAns.operator === "Check Balance"
    ){
        console.log("Your balance is " + myBalance)
    }
    else if(
        operationAns.operator === "Deposit"
    ){
        ...
        if (fastCashAns.FastCash === 500
            ...
            fastCashAns.FastCash === 1000
        ){
            myBalance -= 1000
            console.log("Your remaining balance is " + myBalance)
        }else if(
            fastCashAns.FastCash === 5000
        ){
            myBalance -= 5000
            console.log("Your remaining balance is " + myBalance)
        }else if(
            fastCashAns.FastCash === 10000
        )
        {
            myBalance -= 10000
            console.log("Your remaining balance is " + myBalance)
